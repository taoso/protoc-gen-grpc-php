...
func (g *Generator) generateClient(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto, index int) {
	g.P("<?php")
	g.P("// Generated by the protocol buffer compiler.  DO NOT EDIT!")
	g.P("// source: " + file.GetName())
	g.P()
	...
	g.P("final class " + serviceName + "Client implements " + serviceName)
	g.P("{")
	g.In()
...
func (g *Generator) generateServer(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto, index int) {
	g.P("<?php")
	g.P("// Generated by the protocol buffer compiler.  DO NOT EDIT!")
	g.P("// source: " + file.GetName())
	g.P()
	...
	serviceName := service.GetName()
	g.P("abstract class Abstract" + serviceName + "Server implements " + serviceName)
	g.P("{")
	g.In()
	...
	for _, method := range service.GetMethod() {
		methodName := method.GetName()
		g.P("\"/" + file.GetPackage() + "." + serviceName + "/" + methodName + "\" => \"do" + methodName + "\",")
	}
	g.Out()
	g.P("];")
	g.P()
	...
	for _, file := range g.Request.GetProtoFile() {
		for i, service := range file.GetService() {
			...
			g.Response.File = append(g.Response.File, &plugin.CodeGeneratorResponse_File{
				Name:    proto.String(getFilePath(file.GetPackage(), service.GetName()) + ".php"),
				Content: proto.String(g.String()),
			})

			g.Reset()
			g.generateClient(file, service, i)
			g.Response.File = append(g.Response.File, &plugin.CodeGeneratorResponse_File{
				Name:    proto.String(getFilePath(file.GetPackage(), service.GetName()) + "Client.php"),
				Content: proto.String(g.String()),
			})

			g.Reset()
			g.generateServer(file, service, i)
			g.Response.File = append(g.Response.File, &plugin.CodeGeneratorResponse_File{
				Name:    proto.String(getFilePath(file.GetPackage(), "Abstract"+service.GetName()) + "Server.php"),
				Content: proto.String(g.String()),
			})
		}
	}
